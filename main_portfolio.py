...
def main():
    tempo = time.time() - t0 
    with st.spinner('Caso esteja em um dispositivo mobile, coloque o navegador no modo desktop'):
        time.sleep(5)

    st.image(img_head, use_column_width=True)

    value = presentation_card(image_path="https://raw.githubusercontent.com/AbraaoAndrade/portfolio_streamlit_sharing/main/images/profile.png",
                              name="Abraão Andrade",
